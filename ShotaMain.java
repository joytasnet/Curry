...
public class ShotaMain{
	public static void main(String[] args){
		...
		//トッピングが何種類かを聞く
		System.out.print("何種類?>");
		int kind = new Scanner(System.in).nextInt();


		//トッピング配列をシャッフル
		for(int i=0; i<curry.length-1; i++){
			int index=new Random().nextInt(curry.length-i)+i;
		...
		//結果を表示する
		System.out.printf("今夜のカレーは「%s%sカレー」に決まりました!",num,curry[number]);
